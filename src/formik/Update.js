...
function Update() {
  ...
  const onSubmit = async () => {
    ...
    localStorage.setItem('id',formik.values.id)
    localStorage.setItem("username", formik.values.username);
    localStorage.setItem("email", formik.values.email);
    localStorage.setItem("number", formik.values.number);
    localStorage.setItem("password", formik.values.password);
    localStorage.setItem("cpassword", formik.values.cpassword);
    localStorage.setItem("gender", formik.values.gender);
    localStorage.setItem("nationality", formik.values.nationality);
    localStorage.setItem("dob", formik.values.dob);
    localStorage.setItem("languages", formik.values.languages);
      Navigate1("/read");
     }
     catch(err){
  ...
  const handleCheckboxChange = (value) => {
    const updatedLanguages = formik.values.languages.includes(value)
